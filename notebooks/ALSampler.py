...
class SamplingSimulator():
    def __init__(self, total_docs:List[Doc], total_round:int=10, modelWrapper:object=None, eval_docs:List[Doc]=[], init_seed=14, **kwargs):
...
class VBSamplingSimulator(SamplingSimulator):
    def __init__(self, total_docs:List[Doc], total_round:int=10, modelWrapper:object=None, eval_docs:List[Doc]=[], init_seed=14, faiss_index_path:str=None,
        ...
        """
        super().__init__(total_docs=total_docs, total_round=total_round, modelWrapper=modelWrapper, eval_docs=eval_docs, init_seed=init_seed, 
